...
export const SITE = {
  ...
  nameShort: 'ನೇತಾಜಿ',
  nameEn: 'Netaji Credit Co-operative Society Ltd.',
  established: 1993,
  phone: '080-23601273',
...
export const LOAN_SERVICES = {
  ...
  items: [
    ...
    'ಠೇವಣಿ ಆಧಾರ ಸಾಲ',
    'ವಾಹನ ಸಾಲ',
    'ಸ್ಥಿರಾಸ್ತಿ ಆಧಾರ ಜಾಮೀನು ಸಾಲ',
  ],
}

export const DEPOSIT_SERVICES = {
  kicker: 'ಠೇವಣಿ ಸೇವೆಗಳು',
  title: 'ನಮ್ಮ ಠೇವಣಿ ಸೇವೆಗಳು',
  items: [
    'ಖಾಯಂ ಠೇವಣಿ',
    'ಉಳಿತಾಯ ಠೇವಣಿ',
...
export const FOOTER = {
  copyright: `© ${new Date().getFullYear()} ನೇತಾಜಿ ಕ್ರೆಡಿಟ್ ಕೋ-ಆಪರೇಟಿವ್ ಸೊಸೈಟಿ ಲಿ. All rights reserved.`,
}
